    ...
    <div class="waiting-content">
      <div class="status-card animate__animated animate__fadeIn">
        ...
        <div class="status-message animate__animated animate__fadeInUp">
          <div class="message-primary">Ödeme Bekleniyor</div>
          <div class="message-secondary">Lütfen kartınızı pos cihazından çekmeyiniz</div>
        </div>

        <div class="processing-steps">
          <div class="step completed">
            <div class="step-icon">✓</div>
            <div class="step-label">Bağlantı Kuruldu</div>
          </div>
          ...
          <div class="step active">
            ...
            <div class="step-label">İşlem Sürüyor</div>
          </div>
        ...
        <div class="amount-display animate__animated animate__fadeIn">
          ...
          <div class="amount">{{ basket.total.toFixed(2) }} <span>TL</span></div>
        </div>

        <div class="security-note">
          <div class="security-icon">
            <Lock :width="20" :height="20" :fill="'#636e72'" />
          </div>
